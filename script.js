...
// Menu de idiomas (dropdown) com troca de bandeira
const languageBtn = document.getElementById('languageBtn');
const menu = document.querySelector('.language-dropdown-menu');
const selectedFlag = document.getElementById('selected-flag'); // nova referência à imagem principal

if (languageBtn && menu && selectedFlag) {
  ...
  document.addEventListener('click', function (e) {
    if (!languageBtn.contains(e.target) && !menu.contains(e.target)) {
